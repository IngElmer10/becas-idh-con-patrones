...
<div class="topbar">
  <div class="who"><?= htmlspecialchars((string)($_SESSION['user']['nombre'] ?? ''), ENT_QUOTES, 'UTF-8') ?> — Evaluador</div>
...
<div class="container">
  <div class="h1">Bandeja de evaluación</div>
  ...
  <table class="table">
    ...
    <tbody>
      <?php if (empty($items)): ?>
        <tr><td colspan="5" class="small">No hay postulaciones aptas.</td></tr>
      <?php else: ?>
        <?php foreach ($items as $it): ?>
          <tr>
            ...
            <td><a class="a-btn" href="<?php echo $base_path; ?>/evaluacion/evaluar?id_post=<?= (int)$it['id'] ?>">Evaluar</a></td>
          </tr>
        <?php endforeach; ?>
      <?php endif; ?>
    </tbody>
